...
#resnet152 = timm.create_model("efficientnetv2_rw_t",pretrained=True,pretrained_cfg_overlay=dict(file='C:/Users/ylf/.cache/torch/hub/checkpoints/efficientnetv2_t_agc-3620981a.pth'))
#resnet152 = timm.create_model("efficientnetv2_rw_t",pretrained=True,pretrained_cfg_overlay=dict(file='C:/Users/ylf/.cache/torch/hub/checkpoints/efficientnetv2_t_agc-3620981a.pth'))
resnet152 = timm.create_model("vit_base_patch16_224_miil",pretrained=True,pretrained_cfg_overlay=dict(file='C:/Users/ylf/.cache/torch/hub/checkpoints/vit_base_patch16_224_in21k_miil-887286df.pth'))


#print(resnet152)

resnet152.head = nn.Linear(768, num_classes)
...
# 添加tensorboard
writer = SummaryWriter("./logs_train14")
...
for i in range(epoch):
    ...
    if auc > best_auc:
        best_auc = auc
        torch.save(model, "./model_pth/best_model14.pth")
        print("保存最佳模型")
